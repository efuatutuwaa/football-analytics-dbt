...
def flatten_fixture_statistics(fixture_id: int, record: dict) -> dict:
    team = record.get("team", {})
    stats = {s.get("type"): s.get("value") for s in record.get("statistics", [])}
    return {
        ...
        for row in combos:
            ...
            for fixture_id in new_fixture_ids:
                ...
                for record in records:
                    all_stats.append(flatten_fixture_statistics(fixture_id, record))
